        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row justify-content-between">
					...
					<div class="col-sm-3">
						<a href="/estilista/create" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar estilista</span></a>
					</div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    @forelse ($estilistas as $estilista)
						...
						<td>{{$estilista->apellido_paterno}}</td>
                        <td>{{$estilista->telefono_movil}}</td>
