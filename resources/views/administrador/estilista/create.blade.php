            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" method="POST" action="{{ route('crear_estilista_post') }}">
                        ...
                        <div class="row mb-3">
                            <label for="apellido_paterno" class="col-md-4 col-form-label text-md-end">{{ __('Apellido
                                Paterno') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="telefono_movil" class="col-md-4 col-form-label text-md-end">{{ __('Teléfono
                                Movil') }}</label>

                            <div class="col-md-6">
                                <input id="telefono_movil" type="number" class="form-control @error('telefono_movil') is-invalid @enderror" name="telefono_movil" value="{{ old('telefono_movil') }}" required autocomplete="telefono_movil" autofocus>
