                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="apellido_paterno" type="text" class="form-control @error('apellido_paterno') is-invalid @enderror"
                                        name="apellido_paterno" value="{{ $estilista->apellido_paterno }}" required autocomplete="apellido_paterno" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="telefono_movil" type="text" class="form-control @error('telefono_movil') is-invalid @enderror"
                                        name="telefono_movil" value="{{ $estilista->telefono_movil }}" required autocomplete="telefono_movil" autofocus>
